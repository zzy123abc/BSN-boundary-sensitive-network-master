...
def poolData(data,videoAnno,num_prop=100,num_bin=1,num_sample_bin=3,pool_type="mean"):
    ...
    if len(data)==1:
        ...
        video_feature=np.reshape(video_feature,[num_prop,500])
    ...
    video_feature=[]
    zero_sample=np.zeros(num_bin*500)
...
for videoName in videoNameList:
    ...
    outDf.to_csv("./csv_mean_100/"+"v_"+videoName+".csv",index=False)
